...
//                }
    ...
    private void addBottomDots(int currentPage) {
        ...
        for (int i = 0; i < dots.length; i++) {
            ...
            dots[i].setText(Html.fromHtml(numeros[i]) + " ");
            dots[i].setTextSize(23);
...
//    }
    ...
    public class MyViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            if(position == 0){
                FloatingActionButton fab = (FloatingActionButton) view.findViewById(R.id.fab_descarga_aut);
                fab.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Uri uri = Uri.parse("http://conad.pe/wp-content/uploads/2016/11/Formulario-AUT-2016.pdf");
