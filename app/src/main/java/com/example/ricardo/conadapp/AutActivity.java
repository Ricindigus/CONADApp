...
public class AutActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView = (ImageView)findViewById(R.id.imagen_aut);
        Picasso.with(getApplicationContext()).load("http://imageshack.com/a/img922/3748/o8WgAR.png").fit().into(imageView);
